...
\frame{
    ...
    \begin{tikzpicture}
        ...
        \pause
        % OII emitters
        \draw[<-,color=blue,very thick] (0.5, 2) -- (3, 2) node[anchor=west]{Contaminants: OII emitters};
    \end{tikzpicture}
                ...
                \begin{tikzpicture}
                    \begin{semilogyaxis}
                        [
                            ...
                            %width=6cm,
                            symbolic x coords={plain python,numpy,ufuncify(),opencl CPU, opencl GPU},
                            ymin=0,
                            ylabel=seconds,
                        ...
                        \addplot+ coordinates {
                            ...
                            (ufuncify(), 0.698888063431)
                            (opencl CPU, 0.151912927628)
                            (opencl GPU, 0.16441488266)
                        };
                    \end{semilogyaxis}
                \end{tikzpicture}
            \end{center}
